...
Route::group(['prefix' => 'sales'], function () {
    ...
    Route::get('customers/{customer}/report', 'Sales\Customers@report')->name('customers.report');
    Route::post('customers/{customer}/report', 'Sales\Customers@report')->name('customers.report');
});
