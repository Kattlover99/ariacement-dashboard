                ...
                <tr class="row align-items-center border-top-1">
                    ...
                    @if (!$hideDueAt)
                        <td class="{{ $classDueAt }}">
                            ...
                            @if(!empty($item->due_at)) @if(!empty($item->due_at)) @date($item->due_at) @endif @endif
                        ...
                        <td class="{{ $classActions }}">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item" href="{{ route($routeButtonShow, $item->id) }}/print">{{trans('general.print')}}</a>
                                    
                                    <a class="dropdown-item" href="{{ route($routeButtonShow, $item->id) }}/?payment=1">{{trans('general.add_payment')}}</a>
