                ...
                <table class="table table-flush table-hover">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            ...
                            <th class="col-md-3 col-lg-2 col-xl-1 text-right d-none d-md-block">@sortablelink('sale_price', trans('items.sales_price'))</th>
                            <th class="col-lg-2 col-xl-1 text-right d-none d-lg-block">@sortablelink('purchase_price', trans('items.purchase_price'))</th>
{{--                            lg:8 xl:10:7  --}}
                            <th class="col-lg-1 text-right d-none d-lg-block" title="{{trans('items.product_unit')}}">@sortablelink('product_unit', 'Unit')</th>
                            <th class="col-lg-1 text-right d-none d-lg-block" title="{{trans('items.meter_square')}}">@sortablelink('meter_square', 'Cement')</th>
                    ...
                    <tbody>
                        @foreach($items as $item)
                            <tr class="row align-items-center border-top-1">
                                ...
                                <td class="col-md-3 col-lg-2 col-xl-1 text-right d-none d-md-block">
                                    {{ money($item->sale_price, setting('default.currency'), true) }}
                                </td>
                                <td class="col-lg-2 col-xl-1 text-right d-none d-lg-block">
                                    {{ money($item->purchase_price, setting('default.currency'), true) }}
                                </td>
                                <td class="col-lg-1 text-right d-none d-lg-block">
                                    {{ $item->product_unit }}
                                </td>
                                <td class="col-lg-1 text-right d-none d-lg-block">
                                    {{ $item->meter_square }}
