        ...
        {!! Form::model($item, [
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    {{ Form::selectGroup('product_unit', trans('items.product_unit'), 'pen', [ 'Ton'=>trans('items.ton'), 'MP'=>trans('items.mp'), 'Meter Square'=> trans('items.meter_square') ], $item->product_unit)}}
                    {{ Form::textGroup('meter_square', trans('items.meter_square')) }}
