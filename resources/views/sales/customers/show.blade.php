...
@section('content')
    <div class="row">
        <div class="col-xl-3">
            ...
            <a href="{{ route('customers.report', $customer->id) }}" class="btn btn-info btn-block"><b>{{ trans('general.statement') }}</b></a>
        </div>
                                        ...
                                        <tbody>
                                            @foreach($invoices as $item)
                                                <tr class="row align-items-center border-top-1 tr-py">
                                                    ...
                                                    <td class="col-sm-3 d-none d-sm-block text-left">@if(!empty($item->due_at)) @date($item->due_at) @endif</td>
